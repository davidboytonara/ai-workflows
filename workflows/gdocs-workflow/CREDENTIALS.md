# Credentials you must supply — gdocs-workflow
...
2. Enable the **Google Docs API + Google Drive API** for that project.
...
Required scopes: `documents`, `drive`, `drive.file`.

## First run

```bash
python google-auth-workflow/cli.py docs --account <alias>
```
