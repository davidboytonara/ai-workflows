"""Workflow-local Google auth wrapper used by gslides-workflow scripts."""
...
from google_auth_profiles import GOOGLE_SLIDES_PROFILE, resolve_workflow_credential_root


HELPER = GoogleAuthHelper(
    profile=GOOGLE_SLIDES_PROFILE,
