#!/usr/bin/env python3
"""Verify Gmail authentication for gmail-workflow.
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Verify Gmail authentication for the gmail-workflow.",
    )
    parser.add_argument(
        "--account",
    ...
    try:
        ...
        if verification.ok:
            ...
            print("\nYou can now use the gmail-workflow with this account alias.")
            return 0
