# Credentials you must supply — gsheet-workflow
...
2. Enable the **Google Sheets API + Google Drive API** for that project.
...
Required scopes: `spreadsheets`, `drive`, `drive.file`.

## First run

```bash
python google-auth-workflow/cli.py sheets --account <alias>
```
